...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        patch_theta -= patch_angle_offset;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        feature = [];
        for x = 1:pixelsPerHistogram:patch_size
            for y = 1:pixelsPerHistogram:patch_size
                [histogram, ~] = ComputeGradientHistogram(num_angles,patch_mag(x:x+pixelsPerHistogram-1,y:y+pixelsPerHistogram-1),patch_theta(x:x+pixelsPerHistogram-1,y:y+pixelsPerHistogram-1));
                feature = [feature,histogram];
            end
        end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i = 1:size(gradient_angles,1)
        for j = 1:size(gradient_angles,2)
            histogram(floor(gradient_angles(i,j)/angle_step)+1) += gradient_magnitudes(i,j);
        end
    end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [~,max_direction] = max(histogram);
    direction = angles(max_direction);
    % Step 2:
